...
export default function RegisterPage() {
  ...
  // Redirect to doctor register by default after a short delay
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-400 text-sm">
            Choose your portal to continue with registration
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="h-full hover:shadow-xl transition-all cursor-pointer border-2 hover:border-blue-500 group">
              ...
              <CardContent>
                <p className="text-center text-muted-foreground mb-4">
                  Register to access your clinical dashboard and manage patient care
                </p>
          ...
          <Link href="/patient/register">
            <Card className="h-full hover:shadow-xl transition-all cursor-pointer border-2 hover:border-purple-500 group">
              ...
              <CardContent>
                <p className="text-center text-muted-foreground mb-4">
                  Register to access your health records and book consultations
                </p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Redirecting to Doctor Registration in 5 seconds...
        </p>
      </div>
    </div>
  );
